 ...
 * students.add(new Student((UUID.randomUUID()).toString(), "bhucks", "Brandon",
 * "Hucks", "Student",
 * users.generateStudentID(), null,
 * users.getMajorUUIDByName("Computer Science"),
 ...
 * advisors.add(new Advisor((UUID.randomUUID()).toString(), "klong", "Kyle",
 * "Long", "Advisor",
 ...
 * users.getMajorUUIDByName("Computer Science"),
 * null, 0.0, false, 0, null, null, null));
 * students.add(new Student((UUID.randomUUID()).toString(), "tshrank", "Thomas",
 * "Schrank", "Student",
 * users.generateStudentID(), null,
 * users.getMajorUUIDByName("Computer Science"),
 * null, 0.0, false, 0, null, null, null));
 * students.add(new Student((UUID.randomUUID()).toString(), "jpope", "Jason",
 * "Pope", "Student",
 * users.generateStudentID(), null,
 * users.getMajorUUIDByName("Computer Science"),
 * null, 0.0, false, 0, null, null, null));
 * students.add(new Student((UUID.randomUUID()).toString(), "ajacobson", "Ash",
 * "Jacobson", "Student",
 * users.generateStudentID(), null,
 * users.getMajorUUIDByName("Computer Science"),
 * null, 0.0, false, 0, null, null, null));
 * students.add(new Student((UUID.randomUUID()).toString(), "klong", "Kyle",
 * "Long", "Student",
 * users.generateStudentID(), null,
 * users.getMajorUUIDByName("Computer Science"),
 * null, 0.0, false, 0, null, null, null));
 ...
 * advisors.add(new Advisor((UUID.randomUUID()).toString(), "bhucks", "Brandon",
 * "Hucks", "Advisor",
 * new ArrayList<String>(), "Computer Information Systems"));
 * advisors.add(new Advisor((UUID.randomUUID()).toString(), "tschrank",
 * "Thomas", "Schrank", "Advisor",
 * new ArrayList<String>(), "Computer Information Systems"));
 * advisors.add(new Advisor((UUID.randomUUID()).toString(), "jpope", "Jason",
 * "Pope", "Advisor",
 * new ArrayList<String>(), "Computer Information Systems"));
 * advisors.add(new Advisor((UUID.randomUUID()).toString(), "ajacobson", "Ash",
 * "Jacobson", "Advisor",
 * new ArrayList<String>(), "Computer Information Systems"));
 * DataWriter.saveUsers(students, advisors);
 ...
 * new ArrayList<String>(),
 * new ArrayList<Electives>(), new ArrayList<ApplicationArea>(), 125));
 * majorList.add(new Major((UUID.randomUUID()).toString(),
 * "Computer Information Systems", new ArrayList<String>(),
 * new ArrayList<Electives>(), new ArrayList<ApplicationArea>(), 125));
 * majorList.add(new Major((UUID.randomUUID()).toString(), "Test Major 1", new
 * ArrayList<String>(),
 * new ArrayList<Electives>(), new ArrayList<ApplicationArea>(), 125));
 * majorList.add(new Major((UUID.randomUUID()).toString(), "Test Major 2", new
 * ArrayList<String>(),
 * new ArrayList<Electives>(), new ArrayList<ApplicationArea>(), 125));
 * majorList.add(new Major((UUID.randomUUID()).toString(), "Test Major 3", new
 * ArrayList<String>(),
 * new ArrayList<Electives>(), new ArrayList<ApplicationArea>(), 125));
 * DataWriter.saveMajors();
 ...
 * courseList.add(new Course((UUID.randomUUID()).toString(),
 * "Algorithmic Design I", "CSCE", "145",
 * "SPRING,SUMMER,FALL", new ArrayList<PrereqOptions>(), new
 * ArrayList<String>(), 4, 70));
 ...
 * ArrayList<String>(), 4, 70));
 * courseList.add(new Course((UUID.randomUUID()).toString(),
 * "Algorithmic Design II", "CSCE", "146",
 * "SPRING,SUMMER,FALL", new ArrayList<PrereqOptions>(), new
 * ArrayList<String>(), 4, 70));
 * courseList.add(new Course((UUID.randomUUID()).toString(),
