 ...
 * majors.getMajorByUUID(students.get(0).getMajor()).getMajorName());
 * }
 * 
 * @Test
 * void testGetStudentNoteFromAdvisor() {
 * students = DataLoader.getStudents();
 * assertEquals("Testing note to student",
 * students.get(0).getNoteFromAdvisor());
 * }
 * 
 * @Test
 ...
 * assertEquals("bhucks",
 * users.getStudentByUUID(advisees.get(0)).getUsername());
 * }
 * 
 * // MajorList Testing
 * 
 ...
 * assertEquals("ENGL 101",
 * courses.getCourseByUUID(courseUUID).getCourseName());
 * }
 * 
 * @Test
 ...
 * majorList.get(0).getApplicationAreas().get(0);
 ...
 * courseList = DataLoader.getCourses();
 * String courseUUID =
 * courseList.get(0).getPrerequisites().get(0).getCourses().get(0);
