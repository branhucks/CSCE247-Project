 ...
 * public void setup() {
 * majorList.clear();
 * majorList.add(new Major("Computer Science", new ArrayList<String>(), new
 * ArrayList<Electives>(),
 * new ArrayList<ApplicationArea>(), 125));
 ...
 * assertTrue(majors.addMajor("Computer Information Systems", new
 * ArrayList<String>(), new ArrayList<Electives>(),
 * new ArrayList<ApplicationArea>(), 120));
 * }
 * 
 * @Test
 * void testAddMajorEmptyMajorName() {
 * assertFalse(majors.addMajor("", new ArrayList<String>(), new
 * ArrayList<Electives>(),
 * new ArrayList<ApplicationArea>(), 120));
 * }
 * 
 ...
 * assertFalse(majors.addMajor(null, new ArrayList<String>(), new
 * ArrayList<Electives>(),
 * new ArrayList<ApplicationArea>(), 120));
 * }
 * 
 ...
 * assertFalse(majors.addMajor("Computer Information Systems", null, new
 * ArrayList<Electives>(),
 * new ArrayList<ApplicationArea>(), 120));
 * }
 * 
 ...
 * assertFalse(majors.addMajor("Computer Information Systems", new
 ...
 * assertFalse(majors.addMajor("Computer Information Systems", new
 * ArrayList<String>(), new ArrayList<Electives>(),
 * new ArrayList<ApplicationArea>(), 0));
 * }
 * }
 * 
