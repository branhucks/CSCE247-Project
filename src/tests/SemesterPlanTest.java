 ...
 * assertTrue(semesterPlan.getStudentCourses().contains(new
 * StudentCourse("MATH 141", 1, "Planned", 0, false)));
 * }
 * 
 * @Test
 ...
 * assertTrue(semesterPlan.getStudentCourses().contains(new
 * StudentCourse(" 141", 1, "Planned", 0, false)));
 * }
 * 
 * @Test
 ...
 * assertTrue(semesterPlan.getStudentCourses().contains(new
 * StudentCourse("MATH ", 1, "Planned", 0, false)));
 * }
 * 
 * @Test
 ...
 * assertFalse(semesterPlan.getStudentCourses().contains(new
 * StudentCourse("MATH 141", 1, "Planned", 0, false)));
 * }
 * 
 * }
