...
public class MajorTest {
    ...
    public void setUp() {
        ...
        major = new Major("Computer Science", requiredCourses, electives, applicationAreas, 120);
    }
    @AfterEach
public void tearDown() {
    ...
    public void testGetUUID() {
        ...
        Major majorWithUUID = new Major("some_uuid", "Computer Science", new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), 120);
