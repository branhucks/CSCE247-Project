...
private ArrayList<Course> courseList = courses.getCourses();
	...
	public void setup() {
        courseList.clear();
		courseList.add(new Course("4bd274cb-260e-47a5-9893-203a3943d704","Calculus I", "Math", "141",
    ...
    void testGetCourseByUUID() {
        Course temp = courses.getCourseByUUID("4bd274cb-260e-47a5-9893-203a3943d704");
    ...
    void testGetCourseIDByCourseUUID() {
        String temp = courses.getCourseIDByCourseUUID("4bd274cb-260e-47a5-9893-203a3943d704");
    ...
    void testAddCourseTrue() {
        assertTrue(courses.addCourse("Software Engineering", "CSCE", "247", "SPRING,FALL", new ArrayList<PrereqOptions>(),
        new ArrayList<String>(), 3, 70));
    }
    @Test
    void testAddCourseEmptyName() {
        assertFalse(courses.addCourse("", "CSCE", "247", "SPRING,FALL", new ArrayList<PrereqOptions>(),
        new ArrayList<String>(), 3, 70));
    }
    @Test
    void testAddCourseNullName() {
        assertFalse(courses.addCourse(null, "CSCE", "247", "SPRING,FALL", new ArrayList<PrereqOptions>(),
        new ArrayList<String>(), 3, 70));
    }
    @Test
    void testAddCourseEmptySubject() {
        assertFalse(courses.addCourse("Software Engineering", "", "247", "SPRING,FALL", new ArrayList<PrereqOptions>(),
        new ArrayList<String>(), 3, 70));
    }
    @Test
    void testAddCourseNullSubject() {
        assertFalse(courses.addCourse("Software Engineering", null, "247", "SPRING,FALL", new ArrayList<PrereqOptions>(),
        new ArrayList<String>(), 3, 70));
    }
    @Test
    void testAddCourseEmptyNumber() {
        assertFalse(courses.addCourse("Software Engineering", "CSCE", "", "SPRING,FALL", new ArrayList<PrereqOptions>(),
        new ArrayList<String>(), 3, 70));
    }
    @Test
    void testAddCourseNullNumber() {
        assertFalse(courses.addCourse("Software Engineering", "CSCE", null, "SPRING,FALL", new ArrayList<PrereqOptions>(),
        new ArrayList<String>(), 3, 70));
    }
    @Test
    void testAddCourseEmptySemester() {
        assertFalse(courses.addCourse("Software Engineering", "CSCE", "247", "", new ArrayList<PrereqOptions>(),
        new ArrayList<String>(), 3, 70));
    }
    @Test
    void testAddCourseNullSemester() {
        assertFalse(courses.addCourse("Software Engineering", "CSCE", "247", null, new ArrayList<PrereqOptions>(),
        new ArrayList<String>(), 3, 70));
    }
    @Test
    void testAddCourseNullPrereqs() {
        assertFalse(courses.addCourse("Software Engineering", "CSCE", "247", "SPRING,FALL", null,
        new ArrayList<String>(), 3, 70));
    }
    @Test
    void testAddCourseNullCoreqs() {
        assertFalse(courses.addCourse("Software Engineering", "CSCE", "247", "SPRING,FALL", new ArrayList<PrereqOptions>(),
        null, 3, 70));
    }
}
